        ...
        <div id="card-content">
            <div id="card-title">
             ...
             <form method="post" class="form">
                ...
                <label for="user-reemail" style="padding-top: 22px;">Re-Email</label>
                <input id="user-reemail" class="form-content" type="email" name="reemail" required/>
                <div class="form-border"></div>
                ...
                <a href="#" id="signup">Back To Login</a>
